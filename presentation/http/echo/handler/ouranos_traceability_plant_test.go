...
// /////////////////////////////////////////////////////////////////////////////////
// GET /api/v2/authInfo/plant テストケース
// /////////////////////////////////////////////////////////////////////////////////
...
func TestProjectHandler_GetPlant_Abnormal(tt *testing.T) {
	...
	tests := []struct {
		...
		{
			name:  "1-1. 401: バリデーションエラー：operatorIdのフォーマットエラーの場合",
			input: "invalidUUID",
			modifyQueryParams: func(q url.Values) {
				q.Set("dataTarget", dataTarget)
			},
			expectError: "code=401, message={[auth] Unauthorized Invalid or expired token",
		},
		{
...
// /////////////////////////////////////////////////////////////////////////////////
// GET /api/v2/authInfo/plant 正常系テストケース
// /////////////////////////////////////////////////////////////////////////////////
// [x] 1-1. 200: 正常系
// /////////////////////////////////////////////////////////////////////////////////
...
// /////////////////////////////////////////////////////////////////////////////////
// PUT /api/v2/authInfo/plant 正常系テストケース
// /////////////////////////////////////////////////////////////////////////////////
// [x] 1-1. 201: 正常系：新規作成
...
func TestProjectHandler_PutPlant_Normal(tt *testing.T) {
	...
	tests := []struct {
		name         string
		inputFunc    func() traceability.PlantModelInput
		expectStatus int
	}{
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				...
				putPlantInput.Attribute.PlantID = nil
				putPlantInput.Attribute.PlantAttribute.GlobalPlantID = nil
		...
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantID = nil
				putPlantInput.Attribute.PlantAttribute.GlobalPlantID = common.StringPtr("")
				return putPlantInput
			},
			expectStatus: http.StatusCreated,
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantID = nil
				putPlantInput.Attribute.PlantAttribute = &traceability.PlantAttributeInput{}
				return putPlantInput
			},
			expectStatus: http.StatusCreated,
		},
...
// /////////////////////////////////////////////////////////////////////////////////
// PUT /api/v2/authInfo/plant 異常系テストケース
// /////////////////////////////////////////////////////////////////////////////////
...
// [x] 2-28. 400: バリデーションエラー：DataModelTypeが含まれない場合
// /////////////////////////////////////////////////////////////////////////////////
func TestProjectHandler_PutPlant_Abnormal(tt *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.OperatorID = ""
				return putPlantInput
			},
		...
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.OperatorID = f.InvalidUUID
				return putPlantInput
			},
		...
		{
			name: "2-3. 400: バリデーションエラー：operatorIdの値が36桁でない場合",
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.OperatorID = f.InvalidUUIDLength
				return putPlantInput
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, operatorId: invalid UUID.",
			expectStatus: http.StatusBadRequest,
		...
		{
			name: "2-4. 400: バリデーションエラー：plantNameが含まれない場合",
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantName = ""
				return putPlantInput
			},
		...
		{
			name: "2-5. 400: バリデーションエラー：plantNameが257文字以上の場合",
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantName = ""
				return putPlantInput
			},
		...
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantID = common.StringPtr(f.InvalidUUID)
				return putPlantInput
			},
		...
		{
			name: "2-7. 400: バリデーションエラー：plantIdの値が36桁でない場合",
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantID = common.StringPtr(f.InvalidUUIDLength)
				return putPlantInput
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, plantId: invalid UUID.",
			expectStatus: http.StatusBadRequest,
		...
		{
			name: "2-8. 400: バリデーションエラー：plantAddressが含まれない場合",
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantAddress = ""
				return putPlantInput
			},
		...
		{
			name: "2-9. 400: バリデーションエラー：plantAddressの値が257文字以上の場合",
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantAddress = ""
				return putPlantInput
			},
		...
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.OpenPlantID = nil
				return putPlantInput
			},
		...
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.OpenPlantID = common.StringPtr("Jv0ceJYX9Pa9zQTtlYPQLqLyUUh")
				return putPlantInput
			},
		...
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.OpenPlantID = common.StringPtr("xxxxx-12345x")
				return putPlantInput
			},
		...
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantAttribute = nil
				return putPlantInput
			},
		...
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.PlantAttribute.GlobalPlantID = common.StringPtr("")
				return putPlantInput
			},
		...
		},
		{
			...
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.Attribute.OperatorID = "80762b76-cf76-4485-9a99-cbe609c677c8"
				return putPlantInput
			},
		...
		},
		{
			...
			invalidInputFunc: func() interface{} {
				...
				putPlantInterface.(map[string]interface{})["attribute"] = map[string]interface{}{"operatorId": 1}
		...
		},
		{
			...
			inputFunc:    func() traceability.PlantModelInput { return f.NewPutPlantInput() },
			receive:      fmt.Errorf("Access Error"),
			expectError:  "code=500, message={[auth] InternalServerError Unexpected error occurred",
			expectStatus: http.StatusInternalServerError,
		},
		{
			...
			invalidInputFunc: func() interface{} {
				putPlantInterface := f.NewPutPlantInterface()
				putPlantInterface.(map[string]interface{})["attribute"] = map[string]interface{}{"plantName": 1}
				return putPlantInterface
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, attribute.plantName: Unmarshal type error: expected=string, got=number.",
			expectStatus: http.StatusBadRequest,
		},
		{
		...
		},
		{
			...
			invalidInputFunc: func() interface{} {
				putPlantInterface := f.NewPutPlantInterface()
				putPlantInterface.(map[string]interface{})["attribute"] = map[string]interface{}{"plantAddress": 1}
				return putPlantInterface
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, attribute.plantAddress: Unmarshal type error: expected=string, got=number.",
			expectStatus: http.StatusBadRequest,
		},
		{
		...
		{
			name: "2-28. 400: バリデーションエラー：DataModelTypeが含まれない場合",
			inputFunc: func() traceability.PlantModelInput {
				putPlantInput := f.NewPutPlantInput()
				putPlantInput.DataModelType = ""
				return putPlantInput
			},
