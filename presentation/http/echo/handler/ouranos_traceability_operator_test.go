...
// /////////////////////////////////////////////////////////////////////////////////
// GET /api/v2/authinfo/operator テストケース
// /////////////////////////////////////////////////////////////////////////////////
...
func TestProjectHandler_GetOperator_Normal(tt *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "1-4. 200: 正常系(operatorId指定あり、検索結果0)",
			modifyQueryParams: func(q *url.Values) {
				q.Set("dataTarget", dataTarget)
				q.Set("openOperatorId", f.OpenOperatorID)
			},
		...
		{
			name: "1-5. 200: 正常系(operatorId指定なし、検索結果0)",
			modifyQueryParams: func(q *url.Values) {
				q.Set("dataTarget", dataTarget)
				q.Set("openOperatorId", "")
			},
		...
		{
			name: "1-6. 200: 正常系(operatorIds指定あり、検索結果0)",
			modifyQueryParams: func(q *url.Values) {
				q.Set("dataTarget", dataTarget)
				q.Set("operatorIds", uuid.New().String())
			},
	...
	for _, test := range tests {
		...
		tt.Run(test.name, func(t *testing.T) {
			...
			// 検索結果があった場合の期待値
			expectedModel := traceability.OperatorModel{
				DataModelType: "test",
			...
			expectedModels := []traceability.OperatorModel{
				{
					DataModelType: "test1",
					Attribute: traceability.OperatorAttributeDetail{
						OperatorID:      uuid.MustParse("e03cc699-7234-31ed-86be-cc18c92208e5"),
			...
			if test.name == "1-1. 200: 正常系(operatorId指定あり)" {
				operatorUsecase.On("GetOperator", input).Return(expectedModel, nil)
			} else if test.name == "1-2. 200: 正常系(operatorId指定なし)" {
				operatorUsecase.On("GetOperator", input).Return(expectedModel, nil)
			} else if test.name == "1-3. 200: 正常系(operatorIds指定あり)" {
				operatorUsecase.On("GetOperators", mock.Anything).Return(expectedModels, nil)
			} else if test.name == "1-4. 200: 正常系(operatorId指定あり、検索結果0)" {
				operatorUsecase.On("GetOperator", input).Return(operatorModel, nil)
			} else if test.name == "1-5. 200: 正常系(operatorId指定なし、検索結果0)" {
				operatorUsecase.On("GetOperator", input).Return(operatorModel, nil)
			} else if test.name == "1-6. 200: 正常系(operatorIds指定あり、検索結果0)" {
...
// /////////////////////////////////////////////////////////////////////////////////
func TestProjectHandler_GetOperator_A(tt *testing.T) {
	var method = "GET"
	var endPoint = "/api/v2/authinfo/operator"
	var dataTarget = "operator"
...
// /////////////////////////////////////////////////////////////////////////////////
// GET /api/v2/authinfo/operator/operatorIds テストケース
// /////////////////////////////////////////////////////////////////////////////////
...
// /////////////////////////////////////////////////////////////////////////////////
// PUT /api/v2/authinfo/operator 正常系テストケース
// /////////////////////////////////////////////////////////////////////////////////
...
func TestProjectHandler_PutOperator_Normal(tt *testing.T) {
	...
	tests := []struct {
		name         string
		inputFunc    func() traceability.OperatorModelInput
		expectStatus int
	}{
		{
		...
		},
		{
			...
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorAttributeInput.GlobalOperatorID = common.StringPtr("")
				return putOperatorInput
			},
			expectStatus: http.StatusCreated,
		},
		{
			...
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorAttributeInput = &traceability.OperatorAttributeInput{}
				return putOperatorInput
			},
			expectStatus: http.StatusCreated,
		},
...
// /////////////////////////////////////////////////////////////////////////////////
// PUT /api/v2/authinfo/operator テストケース
// /////////////////////////////////////////////////////////////////////////////////
...
// [x] 1-26. 400: バリデーションエラー：DataModelTypeが存在しない場合
// /////////////////////////////////////////////////////////////////////////////////
func TestProjectHandler_PutOperator(tt *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorID = ""
				return putOperatorInput
			},
		...
		},
		{
			...
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorID = f.InvalidUUID
				return putOperatorInput
			},
		...
		{
			name: "1-5. 400: バリデーションエラー：OperatorIDが36桁ではない場合",
			// (厳密にはUUID形式ではない場合と同一)
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorID = f.InvalidUUIDLength
				return putOperatorInput
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, operatorId: invalid UUID.",
			expectStatus: http.StatusBadRequest,
		...
		{
			name: "1-6. 400: バリデーションエラー：OperatorNameが含まれない場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorName = ""
				return putOperatorInput
			},
		...
		{
			name: "1-7. 400: バリデーションエラー：OperatorNameが256文字以上の場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorName = ""
				return putOperatorInput
			},
		...
		{
			name: "1-8. 400: バリデーションエラー：OperatorAddressが含まれない場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorAddress = ""
				return putOperatorInput
			},
		...
		{
			name: "1-9. 400: バリデーションエラー：OperatorAddressが256文字以上の場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorAddress = ""
				return putOperatorInput
			},
		...
		{
			name: "1-10. 400: バリデーションエラー：OpenOperatorIDが含まれない場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OpenOperatorID = ""
				return putOperatorInput
			},
		...
		{
			name: "1-11. 400: バリデーションエラー：OpenOperatorIDが20文字以上の場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OpenOperatorID = ""
				return putOperatorInput
			},
		...
		{
			name: "1-12. 400: バリデーションエラー：OperatorAttribute.GlobalOperatorIDが256文字以上の場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorAttributeInput.GlobalOperatorID = common.StringPtr("")
				return putOperatorInput
			},
		...
		{
			name: "1-13. 400: バリデーションエラー：OperatorAttributeが含まれない場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorAttributeInput = nil
				return putOperatorInput
			},
		...
		{
			name: "1-14. 400: バリデーションエラー：operatorIdがstring形式でない場合",
			invalidInputFunc: func() interface{} {
				putOperatorInterface := f.NewPutOperatorInterface()
				putOperatorInterface.(map[string]interface{})["attribute"] = map[string]interface{}{"operatorId": 1}
				return putOperatorInterface
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, attribute.operatorId: Unmarshal type error: expected=string, got=number.",
			expectStatus: http.StatusBadRequest,
		},
		{
		...
		},
		{
			...
			invalidInputFunc: func() interface{} {
				putOperatorInterface := f.NewPutOperatorInterface()
				putOperatorInterface.(map[string]interface{})["attribute"] = map[string]interface{}{"operatorName": 1}
				return putOperatorInterface
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, attribute.operatorName: Unmarshal type error: expected=string, got=number.",
			expectStatus: http.StatusBadRequest,
		},
		{
		...
		},
		{
			...
			invalidInputFunc: func() interface{} {
				putOperatorInterface := f.NewPutOperatorInterface()
				putOperatorInterface.(map[string]interface{})["attribute"] = map[string]interface{}{"operatorAddress": 1}
				return putOperatorInterface
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, attribute.operatorAddress: Unmarshal type error: expected=string, got=number.",
			expectStatus: http.StatusBadRequest,
		},
		{
		...
		},
		{
			...
			invalidInputFunc: func() interface{} {
				putOperatorInterface := f.NewPutOperatorInterface()
				putOperatorInterface.(map[string]interface{})["attribute"] = map[string]interface{}{"operatorAttribute": 1}
				return putOperatorInterface
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, attribute.operatorAttribute: Unmarshal type error: expected=traceability.OperatorAttributeInput, got=number.",
			expectStatus: http.StatusBadRequest,
		},
		{
			...
			invalidInputFunc: func() interface{} {
				putOperatorInterface := f.NewPutOperatorInterface()
				putOperatorInterface.(map[string]interface{})["attribute"].(map[string]interface{})["operatorAttribute"].(map[string]interface{})["globalOperatorId"] = 1

				fmt.Println(putOperatorInterface)
				return putOperatorInterface
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, attribute.operatorAttribute.globalOperatorId: Unmarshal type error: expected=string, got=number.",
			expectStatus: http.StatusBadRequest,
		},
		{
			name: "1-24. 400: バリデーションエラー：1-3と1-6が同時に発生する場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorID = ""
				putOperatorInput.Attribute.OperatorName = ""
		...
		{
			name: "1-25. 400: バリデーションエラー：1-3と1-13が同時に発生する場合(operatorIdとoperatorAttributeが含まれない)",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.Attribute.OperatorID = ""
				putOperatorInput.Attribute.OperatorAttributeInput = nil
		...
		{
			name: "1-26. 400: バリデーションエラー：DataModelTypeが存在しない場合",
			inputFunc: func() traceability.OperatorModelInput {
				putOperatorInput := f.NewPutOperatorInput()
				putOperatorInput.DataModelType = ""
				return putOperatorInput
			},
			expectError:  "code=400, message={[auth] BadRequest Validation failed, dataModelType: cannot be blank.",
			expectStatus: http.StatusBadRequest,
		},
	}
