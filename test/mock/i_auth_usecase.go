...
// Login provides a mock function with given fields: _a0
func (_m *IAuthUsecase) Client(_a0 input.ClientParam) (output.ClientResponse, error) {
	ret := _m.Called(_a0)
	...
	var r0 output.ClientResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(input.ClientParam) (output.ClientResponse, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(input.ClientParam) output.ClientResponse); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(output.ClientResponse)
	}

	if rf, ok := ret.Get(1).(func(input.ClientParam) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
